...
Board/NUCLEO_F411RE/Startup/%.o: ../Board/NUCLEO_F411RE/Startup/%.s Board/NUCLEO_F411RE/Startup/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -DDEBUG -c -I"D:/sg_private/ST_Study/test/Board/NUCLEO_F411RE/Startup" -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
